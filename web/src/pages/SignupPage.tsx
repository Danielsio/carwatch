...
export function SignupPage() {
  ...
  return (
    <div dir="rtl" className="relative min-h-screen overflow-hidden bg-background">
      ...
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_70%,var(--color-glow-success),transparent_45%)]"
        aria-hidden
      />
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-12">
        <div className="w-full max-w-[420px] animate-fade-in">
          ...
          <div className="rounded-2xl border border-border/60 bg-card/80 p-6 shadow-[0_24px_64px_-16px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:p-8">
            {error && (
              <div
                className="mb-5 rounded-xl border border-destructive/40 bg-destructive/15 px-4 py-3 text-sm font-medium text-destructive"
                role="alert"
              >
                {error}
              </div>
