...
Issue numbers are filled in after filing (see [06-roadmap.md](06-roadmap.md) for sequencing).
...
- **Issue:** TBD · quick-win PR 7 (last in sequence — highest behavioral risk)
...
- **Issue:** TBD · short-term (grouped hardening)
...
- **Issue:** TBD · quick-win PR 1 (first — buys coverage headroom)
